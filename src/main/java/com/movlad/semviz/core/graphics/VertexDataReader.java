...
/**
 * Basic text file reader, retrieving vertex buffer data separated by spaces and
 * lines.
 */
public class VertexDataReader {
    ...
    public VertexDataReader(String path) {
        this.path = path;
    }
     ...
     *
     * @throws IOException if the file is non existent or there are problems
     * opening the different buffers
     */
